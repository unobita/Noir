...
async def incoming_compress_message_f(update):
    ...
    try:
        ...
        joined_string = f"S1E{episode_no} - {anime_name} [480p][Dual][@Anime_Sensei_Network].mkv"
        if 'anime_season' in new_name.keys():
            animes_season = new_name['anime_season']
            joined_string = f"S{animes_season}E{episode_no} - {anime_name} [480p][Dual][@Anime_Sensei_Network].mkv"
